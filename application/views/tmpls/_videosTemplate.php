      <section id="videos_section" class="track_section">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-4">
              <div class="section_head_widget animatedParent ">
                <h2 class="animated fadeInLeft">vip video</h2>
                <h5 class="animated bounceInRight">All Videos</h5>
              </div>
              <!--section_head_widget--> 
            </div>
            <div class="col-xs-12 col-sm-4 text-right video-genre">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <?php foreach($videoGenres as $key=>$val): ?>
                      <li><a href="javascript:void(0);" data-genre="<?php echo $val->slug; ?>"><?php echo $val->name; ?></a></li>
                    <?php endforeach; ?>
                  </ul>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 text-right video-subgenre">
                <div class="btn-group">
          ...
          <div class="tours_widget">
            ...
            <?php foreach($videos as $vKey => $vVal): ?>
          ...
          <ul id="video-pagination" class="pagination-sm"></ul>
        </div>
